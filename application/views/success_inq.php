                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="col-md-4"></div>
                                    ...
                                    <i class="fa fa-calendar fa-fw"></i><?php echo $blog['blog_date_posted'];?>                
                                  </div>
                                </div>
                            <h3><a class="link-color" href="#"><?php echo $blog['blog_hashtag'];?></a></h3>
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            ...
                            <h3><a class="link-color" href="<?php echo base_url();?>blogs">#FirstBuyer</a></h3>
                            ...
                            <a href="<?php echo base_url();?>blogs" class="btn btn-primary btn-sm pull-right">Read More</a>
                            </div>
                        </div>
                        <h2>News</h2>
                        <div class="row">
                            ...
                            <blockquote><h4><a class="link-color" href="<?php echo base_url();?>blogs">Robinsons Land Corporation bags back-to-back Euromoney Overall Best Managed Company in the Philippines Award.</a></h4></blockquote>
                            <a href="<?php echo base_url();?>blogs" class="btn btn-primary btn-sm pull-right">Read More</a>
                            </div>
                        </div>
                    </div>
