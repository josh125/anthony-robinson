      ...
      <div class="panel panel-default">
        <div class="panel-body">
          <div class="row">
            ...
            <div class="col-md-8">
              <ul class="nav nav-tabs" role="tablist">
                <li><a href="<?php echo site_url();?>manage/dashboard"><i class="fa fa-dropbox fa-fw fa-1x"></i> All inquiries</a></li>
                <li><a href="<?php echo site_url();?>manage/important"><i class="fa fa-star-o fa-fw fa-1x yellow"></i> Important</a></li>
                <li class="active"><a href="<?php echo site_url();?>manage/trashbin"><i class="fa fa-trash-o fa-fw fa-1x red"></i> Trash Bin</a></li>
              </ul>
            </div>
          </div>
          ...
          <?php if (count($inquiries)): ?><?php foreach ($inquiries as $inq): ?>                             
            <div class="row">
              <div class="col-md-12 text-right"><i class="fa fa-trash-o fa-fw fa-1x red"></i></div>
            </div>            
            <div class="row">
              <div class="col-md-12">
                <ul class="nav navbar-right">
                  <a class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li><?php echo anchor('manage/trashbin/return_dash_inq/'.$inq['inq_id'],'<i class="fa fa-dropbox fa-1x fa-fw blue"></i>Return to all inquiries');?></li>
                      <li><?php echo anchor('manage/trashbin/sendtoimportant/'.$inq['inq_id'],'<i class="fa fa-trash-o fa-1x fa-fw yellow"></i> Important');?></li>
                      <li><?php echo anchor('manage/trashbin/delete_inq/'.$inq['inq_id'],'<i class="fa fa-unlink fa-1x fa-fw red"></i> Delete');?></li>
                    </ul>
                  </a>
                </ul>              
              </div>
