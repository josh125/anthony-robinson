    ...
    <div class="col-md-8">
      <div class="panel panel-default">
        <div class="panel-body">
          <div class="row">
            <div class="col-md-4">
              <h1 class="text-left"><small><i class="fa fa-users fa-fw fa-1x"></i> Inquiries</small></h1>
            </div><br>
            <div class="col-md-8">
              <ul class="nav nav-tabs" role="tablist">
                <li class="active"><a href="<?php echo site_url();?>manage/dashboard"><i class="fa fa-dropbox fa-fw fa-1x blue"></i> All inquiries</a></li>
                ...
                <ul class="nav navbar-right">
                  <a class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li><?php echo anchor('manage/dashboard/sendtoimportant/'.$inq['inq_id'],'<i class="fa fa-star-o fa-1x fa-fw yellow"></i>Important');?></li>
                      <li><?php echo anchor('manage/dashboard/sendtotrashbin/'.$inq['inq_id'],'<i class="fa fa-trash-o fa-1x fa-fw red"></i>Trash Bin');?></li>
                    </ul>
                  </a>
                </ul>              
              </div>
